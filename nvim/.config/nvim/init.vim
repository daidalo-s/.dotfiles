...
let NERDTreeMinimalMenu = 1 "Minimal menu
let NERDTreeWinPos = "left" "panel opens on left side
let NERDTreeWinSize = 31 "Panel width 31 columns
...
set statusline^=%{8*coc#status()}%{get(b:,'coc_current_function','')}
